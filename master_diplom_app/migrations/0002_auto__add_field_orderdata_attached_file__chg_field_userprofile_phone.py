...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderData.attached_file'
        db.add_column('master_diplom_app_orderdata', 'attached_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'UserProfile.phone'
        db.alter_column('master_diplom_app_userprofile', 'phone', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UserProfile.phone'
        db.alter_column('master_diplom_app_userprofile', 'phone', self.gf('django.db.models.fields.IntegerField')(default=''))
